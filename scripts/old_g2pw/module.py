...
class G2PW(BertPreTrainedModel):
    def __init__(self, model_source, labels, chars, pos_tags,
        ...
        if self.use_conditional:
            ...
            if self.param_conditional['fix_mode']:
                ...
                count_dict = json.load(open(self.param_conditional['count_json'], encoding="utf-8"))
    ...
    def _weighted_softmax(self, logits, weights):
        eps = 1e-6
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, phoneme_mask, char_ids, position_ids, pos_ids=None, label_ids=None):
        ...
        probs = self._weighted_softmax(logits, phoneme_mask)
